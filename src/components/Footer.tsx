      ...
      >
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <span
              className="font-[family-name:var(--font-display)] text-xl tracking-wider"
          ...
          <p className="text-sm text-center" style={{ color: "var(--text-muted)" }}>
            © {currentYear} NH Prince Prodhan. All rights reserved.
          </p>
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="transition-colors hover:text-[var(--accent-from)]"
            ...
            <a
              href="https://www.linkedin.com/in/nh-prince-prodhan-a1b46a399"
              target="_blank"
              rel="noopener noreferrer"
